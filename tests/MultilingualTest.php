...
use PEAVEL\Pilot\Translator\Collection;
...
class MultilingualTest extends TestCase
{
    public function setUp(): void
    {
        ...
        config()->set('pilot.multilingual.locales', ['en', 'da']);

        // Turn on multilingual
        config()->set('pilot.multilingual.enabled', true);
    }

    public function testCheckingModelIsTranslatable()
    {
        $this->assertTrue(Pilot::translatable(TranslatableModel::class));
        $this->assertTrue(Pilot::translatable(ActuallyTranslatableModel::class));
    }

    public function testCheckingModelIsNotTranslatable()
    {
        $this->assertFalse(Pilot::translatable(NotTranslatableModel::class));
        $this->assertFalse(Pilot::translatable(StillNotTranslatableModel::class));
    }
