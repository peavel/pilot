...
namespace PEAVEL\Pilot\Tests\Unit\Actions;

use PEAVEL\Pilot\Actions\AbstractAction;
...
class AbstractActionTest extends TestCase
{
     ...
     *
     * @var \PEAVEL\Pilot\Models\DataType
     */
    ...
    public function setUp(): void
    {
        ...
        $this->userDataType = Pilot::model('DataType')->where('name', 'users')->first();
