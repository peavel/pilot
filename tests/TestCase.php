...
class TestCase extends OrchestraTestCase
{
    ...
    protected function getEnvironmentSetUp($app)
    {
        ...
        $app['config']->set('pilot.user.namespace', User::class);
    ...
    {
        $this->artisan('pilot:install', ['--with-dummy' => $this->withDummy]);

        app(PilotServiceProvider::class, ['app' => $this->app])->loadAuth();
