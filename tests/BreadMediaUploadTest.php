...
class BreadMediaUploadTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->storage = Storage::disk(config('pilot.storage.disk'));
    }
    ...
    public function testMultipleImagesDelete()
    {
        ...
        $response = $this->post(route('pilot.pages.media.remove'), [
            'id'        => $page->id,
            'slug'      => 'pages',
            'field'     => 'image',
            'multi'     => 'true',
    ...
    public function testFileDelete()
    {
        ...
        $this->call('POST', route('pilot.pages.media.remove'), [
            'id'        => $page->id,
            'slug'      => 'pages',
            'field'     => 'image',
            'multi'     => 'true',
    ...
    public function testUploadSecondFile()
    {
        ...
        $this->call('PUT', route('pilot.pages.update', $page->id), [
