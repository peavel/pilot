...
trait PilotUser
{
    ...
    {
        return $this->belongsTo(Pilot::modelClass('Role'));
    }
    ...
    {
        return $this->belongsToMany(Pilot::modelClass('Role'), 'user_roles', 'user_id', 'role_id');
    }
    ...
    {
        $role = Pilot::model('Role')->where('name', '=', $name)->first();
