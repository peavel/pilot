...
class PilotDummyServiceProvider extends ServiceProvider
{
    ...
    private function registerPublishableResources()
    {
        ...
        $publishable = [
            ...
            'dummy_config' => [
                "{$publishablePath}/config/pilot_dummy.php" => config_path('pilot.php'),
            ],
            'dummy_migrations' => [
    ...
    public function registerConfigs()
    {
        $this->mergeConfigFrom(
            dirname(__DIR__).'/../publishable/config/pilot_dummy.php',
            'pilot'
        );
    }
}
