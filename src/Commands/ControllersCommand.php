...
class ControllersCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'pilot:controllers';
     ...
     * @var string
     */
    protected $description = 'Publish all the controllers from Pilot.';
    ...
    {
        $stub = $this->getStub();
        $files = $this->filesystem->files(base_path('vendor/peavel/pilot/src/Http/Controllers'));
        $namespace = config('pilot.controllers.namespace', 'PEAVEL\\Pilot\\Http\\Controllers');
        ...
        $this->info('Published Pilot controllers!');
    }
    ...
    {
        return $this->filesystem->get(base_path('/vendor/peavel/pilot/stubs/'.$this->stub));
    }
    ...
    protected function generateContent($stub, $class)
    {
        ...
        $content = str_replace(
            'FullBaseDummyClass',
            'PEAVEL\\Pilot\\Http\\Controllers\\'.$class,
            $content
        );
