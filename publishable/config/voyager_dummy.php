...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Here you can specify pilot user configs
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Here you can specify pilot controller settings
    |
    */
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Here you can specify pilot database settings
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Here you can specify if you want Pilot to ship with support for
    ...
    */
    ...
    'dashboard' => [
        ...
        'navbar_items' => [
            ...
            'pilot::generic.home' => [
                'route'        => '/',
                'icon_class'   => 'pilot-home',
                'target_blank' => true,
            ],
            'pilot::generic.logout' => [
                'route'      => 'pilot.logout',
                'icon_class' => 'pilot-power',
            ],
        ],

        'widgets' => [
            'PEAVEL\\Pilot\\Widgets\\UserDimmer',
            'PEAVEL\\Pilot\\Widgets\\PostDimmer',
            'PEAVEL\\Pilot\\Widgets\\PageDimmer',
        ],
    ...
    |--------------------------------------------------------------------------
    |
    | When a change happens on Pilot, we can automate some routines.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Here you change some of the Pilot UI settings.
    |
    */
