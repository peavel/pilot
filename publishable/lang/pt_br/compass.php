...
return [
    'welcome'                => 'Bem-vindo à Bússola do Pilot. Todo bom app precisa de uma bússola para mostrar a direção correta.
    Nessa seção você encontrará muitos recursos e tarefas administativas que o guiará na construção de sua aplicação.',
    'links'         => [
        'title'                 => 'Links',
        'documentation'         => 'Documentação',
        'pilot_homepage'      => 'Página Inicial do Pilot',
    ],
    'commands'      => [
        'title'                 => 'Comandos',
        'text'                  => 'Rodar Comandos Artisan a partir do Pilot.',
    ...
    'resources'     => [
        'title'                 => 'Recursos',
        'text'                  => 'Os Recursos Pilot ajudará você encontrar as coisas mais rápido.',
    ...
    'fonts'         => [
        'title'                 => 'Fontes',
        'font_class'            => 'Mapa de Classe de Fonte Pilot',
        'font_character'        => 'Mapa de Caracteres de Fonte Pilot',
    ],
];
