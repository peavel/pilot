...
return [
    'welcome'                => 'Pilotコンパスへようこそ。 すべての素晴らしいアプリケーションには正しい方向を示すコンパスが必要です。
        このセクションでは、アプリケーションを構築する際に役立つ多くのリソースと管理タスクを紹介します。',
    'links'         => [
        'title'                 => 'リンク',
        'documentation'         => 'ドキュメント(英語サイト)',
        'pilot_homepage'      => 'Pilot ホームページ (英語サイト)',
    ],
    'commands'      => [
        'title'                 => 'コマンド',
        'text'                  => 'PilotからArtisanコマンドを実行します。',
        'clear_output'          => '出力をクリア',
    ...
    'resources'     => [
        'title'                 => 'リソース',
        'text'                  => 'Pilotリソースはより素早く探しものをする手助けとなります。',
    ...
    'fonts'         => [
        'title'                 => 'フォント',
        'font_class'            => 'Pilot Fonts Class マッピング',
        'font_character'        => 'Pilot Fonts Character マッピング',
    ],
];
