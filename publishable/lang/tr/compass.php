...
return [
    'welcome'                => 'Pilot Pusula\'ya hoşgeldiniz. Her iyi uygulama doğru istikamette ilerlemek için bir pusulaya ihtiyaç duyar.
    Bu bölümde uygulamanızı geliştirirken size rehberlik edecek bir çok kaynak ve yönetimsel görev bulacaksınız.',
    'links'         => [
        'title'                 => 'Bağlantılar',
        'documentation'         => 'Dokümantasyon',
        'pilot_homepage'      => 'Pilot Anasayfa',
    ],
    'commands'      => [
        'title'                 => 'Komutlar',
        'text'                  => 'Artisan Komutlarını Pilot\'dan Çalıştır.',
    ...
    'resources'     => [
        'title'                 => 'Kaynaklar',
        'text'                  => 'Aradığınız şeyleri bulmanızı kolaylaştıracak Pilot kaynakları.',
    ...
    'fonts'         => [
        'title'                 => 'İkonlar',
        'font_class'            => 'Pilot İkon Class Eşleştirmesi',
        'font_character'        => 'Pilot İkon Karakter Eşleştirmesi',
    ],
];
