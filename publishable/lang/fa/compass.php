...
return [
    'welcome'                => '
    به قطب نمای pilot خوش آمدید! هر اپلیکیشن خوب باید یک قطب نما داشته باشد که کاربران را به جهات صحیح هدایت کند!.
    ...
    'links'         => [
        ...
        'pilot_homepage'      => 'صفحه اصلی pilot',
    ],
    'commands'      => [
        'title'                 => 'دستورات',
        'text'                  => 'اجرای دستورات Artisan از pilot',
    ...
    'resources'     => [
        'title'                 => 'منابع',
        'text'                  => 'منابع Pilot برای کمک به شما جهت یافتن سریع تر آنچه به دنبالش هستید',
    ...
    'fonts'         => [
        'title'                 => 'فونت ها',
        'font_class'            => 'نقشه کلاس های فونت Pilot',
        'font_character'        => 'نقشه کاراکترهای فونت Pilot',
    ],
];
