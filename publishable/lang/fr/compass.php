...
return [
    'welcome'                => 'Bienvenue sur Pilot Compass. Chaque nouvelle application a besoin d\'une boussole pour se diriger dans la bonne direction.
    ...
    'links'         => [
        ...
        'pilot_homepage'      => 'Pilot Homepage',
    ],
    'commands'      => [
        'title'                 => 'Commandes',
        'text'                  => 'Lancer les Commandes artisan depuis Pilot.',
    ...
    'resources'     => [
        'title'                 => 'Ressources',
        'text'                  => 'Ressources Pilot pour vous aider a trouver certaines choses plus vite.',
    ],
    'logs'          => [
        'title'                 => 'Logs',
    ...
    'fonts'         => [
        ...
        'font_class'            => 'Classe de correspondance à la police Pilot',
        'font_character'        => 'Caractère de correspondance à la police Pilot',
    ],
];
