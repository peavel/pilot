...
return [
    'welcome'           => 'Välkommen till Pilot Compass. Alla bra appar behöver in kompass som visar riktningen.
    I denna avdelning hittar du resurser som hjälper dig att bygga din applikation',
    'links' => [
        'title'                 => 'Länkar',
        'documentation'         => 'Dokumentation',
        'pilot_homepage'      => 'Pilot Hemsida',
    ],
    'commands' => [
        'title'                 => 'Kommandon',
        'text'                  => 'Kör Artisan Kommandon från Pilot.',
    ...
    'resources' => [
        'title'                 => 'Resurser',
        'text'                  => 'Pilot resurser som hjälper dig hitta snabbare.',
    ],
    'logs' => [
        'title'                 => 'Loggar',
    ...
    'fonts' => [
        'title'                 => 'Typsnitt',
        'font_class'            => 'Pilot Typsnitt Klasser',
        'font_character'        => 'Pilot Typsnitt Tecken',
    ],
];
