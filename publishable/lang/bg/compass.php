...
return [
    'welcome'                => 'Добре дошли във Pilot Compass. Всяка хубава апликация има нужда от компас да насочва потребителите към правилната посока.

    В тази секция ще намерите много ресурси и административки задачи, които ще ви помогнат да създадете вашата апликация.',
    'links'         => [
        'title'                 => 'Линкове',
        'documentation'         => 'Документация',
        'pilot_homepage'      => 'Начална страница на Pilot',
    ],
    'commands'      => [
        'title'                 => 'Команди',
        'text'                  => 'Run Artisan команди от Pilot.',
    ...
    'resources'     => [
        'title'                 => 'Ресурси',
        'text'                  => 'Pilot ресурси, които ще ви помогнат да намерите всичко по-бързо.',
