...
return [
    'welcome'                => 'Բարի գալուստ Pilot կողմնացույց. Յուրաքանչյուր լավ հավելվածի պետք է կողմնացույց, որը կմատնանշի նրանց ճիշտ ուղղությամբ։
    ...
    'links'         => [
        ...
        'pilot_homepage'      => 'Pilot Գլխավոր էջ',
    ],
    'commands'      => [
        'title'                 => 'Հրամաններ',
        'text'                  => 'Աշխատեցնել Artisan հրամանները Pilot-ից։',
    ...
    'resources'     => [
        'title'                 => 'Ռեսուրսներ',
        'text'                  => 'Pilot-ի ռեսուրսները օգնում են Ձեզ գտնել ավելի արագ',
    ...
    'fonts'         => [
        'title'                 => 'Տառատեսակներ',
        'font_class'            => 'Pilot-ի տառատեսակների դասերի քարտեզագրում',
        'font_character'        => 'Pilot-ի տառատեսակների նիշերի քարտեզագրում',
    ],
];
