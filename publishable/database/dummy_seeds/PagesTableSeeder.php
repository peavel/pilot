...
class PagesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        if (!$dataType->exists) {
            $dataType->fill([
                'name'                  => 'pages',
                'display_name_singular' => __('pilot::seeders.data_types.page.singular'),
                'display_name_plural'   => __('pilot::seeders.data_types.page.plural'),
                'icon'                  => 'pilot-file-text',
                'model_name'            => 'PEAVEL\\Pilot\\Models\\Page',
                'controller'            => '',
        ...
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'image',
                'display_name' => __('pilot::seeders.data_rows.page_image'),
                'required'     => 0,
                'browse'       => 1,
                'read'         => 1,
                'edit'         => 1,
        ...
        $menuItem = MenuItem::firstOrNew([
            'menu_id' => $menu->id,
            'title'   => __('pilot::seeders.menu_items.pages'),
            'url'     => '',
